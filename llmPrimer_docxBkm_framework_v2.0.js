...
, 
    registerKnowledgeBase = (id, name, docxUrl, category) => {
        registeredBases[id] = {
            name,
            docxUrl,
            category
...
, 
    K = async() => {
        const e = document.getElementById("source-select").value;
        if(!e || !registeredBases[e]) return;
        
        const S = document.getElementById("load-status"),
        kb = registeredBases[e];
        ...
        try {
            ...
            // No need for feature selection with DOCX files
            const featureSelect = document.getElementById("feature-select");
            featureSelect.innerHTML = "";
            featureSelect.disabled = true;
            
            S && (S.textContent = `${kb.name} data loaded successfully`, S.style.color = "green");
        } catch(error) {
...
, 
    ...
    I = () => {
        ...
        if(t) {
            // Create a file transfer event to drop the DOCX into the textarea
            ...
            // Assign the DataTransfer object to the event
            ...
            // Trigger any necessary input events
