 ...
 * 
 * Important: JSON data is embedded directly in this file to avoid loading issues in bookmarklet context
 */
(function() {
    // Private utilities
    const utils = {
    ...
    // Pre-embedded JSON data for Usability Heuristics
    ...
    // Placeholder for Dark Patterns data - add the complete JSON similarly
    // You can find the dark patterns data in the files provided or add a placeholder
    const darkPatternsData = {
        "title": "Dark Patterns Guide",
        "name": "Dark Patterns Knowledge Base",
        // Add the complete dark patterns data structure here when available
        "llmInstructions": "You are an expert in identifying and analyzing dark patterns in user interfaces.",
        "userInstructions": "To analyze interfaces for dark patterns, provide screenshots or detailed descriptions of the UI."
    };
    ...
    const kbResearch = {
        ...
        features: {
            darkPatterns: { title: "Dark Patterns" },
            usabilityHeuristics: { title: "Usability Heuristics" }
        },
        loadedFeatures: {
            // Pre-populate with embedded data
         ...
         */
        initialize: function() {
            utils.log("Initializing Research Knowledge Base with pre-embedded data...");
            ...
            utils.log("Research Knowledge Base initialized successfully with embedded data");
            
            // Update UI if possible
            const statusElement = document.getElementById('load-status');
            if (statusElement) {
                statusElement.textContent = "Data pre-loaded and ready to use";
        ...
        generatePrompt: function(featureId) {
            ...
            if (!this.loadedFeatures[featureId]) {
                return `Error: Feature "${featureId}" data is not available.`;
            }
        ...
        /**
         * Generic prompt generator that uses data from the embedded JSON
